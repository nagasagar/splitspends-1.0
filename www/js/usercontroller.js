angular.module('starter.controllers').controller('usercontrol', function($scope, $ionicModal, $ionicPopup, $cordovaSQLite, $timeout, $state, UserService, GroupService) {
    ...
    $scope.deleteuser = function(user) {
        console.log('Doing deleteuser', user);
    };
...
.controller('userdetailcontroltrl', function ($scope, $stateParams,$ionicActionSheet,$ionicPopup,$timeout, UserService, ExpenseService, GroupService) {
    $scope.$on('$ionicView.enter', function() {
